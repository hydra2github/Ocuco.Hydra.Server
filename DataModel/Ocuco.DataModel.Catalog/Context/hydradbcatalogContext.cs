...
namespace Ocuco.DataModel.Catalog.Context
{
    public partial class hydradbcatalogContext : DbContext
    {
        ...
        public hydradbcatalogContext(DbContextOptions<hydradbcatalogContext> options) : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.SubscriptionKey).HasMaxLength(50);
            });
